...
<svelte:head>
  <title>AI in Disney TV Shows - Disney AI Adoption Hub</title>
</svelte:head>

<!-- Hero Section -->
<section class="relative overflow-hidden bg-gradient-to-br from-purple-900 via-pink-900 to-orange-900 text-white">
  ...
  <div class="relative z-10 container mx-auto px-4 py-20">
    <h1 class="text-5xl md:text-6xl font-bold mb-6">AI in Disney TV Shows</h1>
    <p class="text-xl md:text-2xl mb-8 text-purple-100">
      Transforming television content creation and viewer experiences with artificial intelligence
    </p>
